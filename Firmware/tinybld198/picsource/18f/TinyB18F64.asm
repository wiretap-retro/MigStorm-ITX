	radix DEC
	LIST      P=18F4620	; change also: Configure->Select Device from MPLAB
...
;	This source file is for PIC18F2525, 2620, 4525, 4620, 2585, 2680, 4585, and 4680.
